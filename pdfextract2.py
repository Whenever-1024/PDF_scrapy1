                ...
                for text_line in element:
                    for character in text_line:
                        if isinstance(character, LTChar):                            
                            ...
                            elif round(character.size) == 12 and round(element.bbox[0],1) == 559.8:
                                broken_page = False
...
for page_layout in extract_pages(FILE,'', pages, laparams=_LA_PARAMS):
    ...
    for element in page_layout:
        ...
        if isinstance(element, LTTextContainer) and ((broken_page == True and element.bbox[1] < broken_y) or broken_page == False):
            elText = element.get_text()
            ## check the record number and y-coordinate of each record.
            if (elText == '1 \n' or elText == '2 \n' or elText == '3 \n') and round(element.bbox[0], 2) == 570.6:
                recordIndex.append({'y': round(element.bbox[1],3)})
            ...
            for text_line in element:
                for character in text_line:
                    if isinstance(character, LTChar):                                
                        ...
                        ## find out losted record (d and e)
                        elif round(character.bbox[0]) == 308 and round(element.bbox[0], 1) == 173.7:
                            print(elText)
                            temp = ''
                            for cha in text_line:
                                if type(cha) == LTChar:
                        ...
                        ## find out losted record (e and f)
                        elif round(character.bbox[0]) == 443 and round(element.bbox[0]) == 308:
                            print(elText)
                            temp = ''
                            for cha in text_line:
                                if type(cha) == LTChar:
                        ...
                        ## find out losted record (f and recordIndex)
                        elif round(character.bbox[0],1) == 570.6 and round(element.bbox[0]) == 443:
                            print(elText)
                            temp = ''
                            for cha in text_line:
                                if type(cha) == LTChar:
                            ...
                            if elText.startswith('C U A R T A')>0:
                                ...
                                Juzgado = elText.replace(' ', '')
                                break
                            elif elText.startswith('Q U I N T A')>0:
                                Fecha.append(elText)
                                Juzgado_start = 10
                                broken_y = element.bbox[1]
                                break
                    ...
                    if isinstance(character, LTChar):                                
                        ...
                        ## find out losted record (f and recordIndex)
                            ...
                            if elText.startswith('Q U I N T A')>0:
                                ...
                                Juzgado = elText.replace(' ', '')
                                break                            
                            elif elText.startswith('S E X T A')>0:
                                Fecha.append(elText)
                                Juzgado_start = 11
                                broken_y = element.bbox[1]
                                break
