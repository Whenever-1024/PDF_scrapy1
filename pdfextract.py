    ...
    if page_number > 2 and Juzgado_start != 2: ## Juz_start
        ...
        if len(recordIndex) > 0:
            ...
            for r in recordIndex:
                i += 1
                dic = {
                    "actor" : d_result[i].upper(),
                    "demandado" : e_result[i].upper(),
                    "entidad" : 'CIUDAD DE MEXICO',
                    "expediente" :c_result[i].upper(),
                    "fecha" : Fecha[0].upper(),
                    "fuero" : 'FEDERAL',
                    "juzgado" : Juzgado.upper(),
                    "tipo" : '',
                    "acuerdos" : f_result[i].upper(),
                    "monto": '',
                    "fecha_presentacion": '',
                    "actos_reclamados": '',
        ...
        if len(recordIndex) > 0:                    
            ...
            for r in recordIndex:
                ...
                dic = {
                    ...
                    "Prestación_demandada": '',
                    "Organo_jurisdiccional_origen": '',
                    "expediente_origen": c_result[i].upper(),
                    "materia": 'LABORAL',
                    "submateria": '',
                    "fecha_sentencia": '',
                    "sentido_sentencia": '',
